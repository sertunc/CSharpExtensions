...
public static class StringExtension 
{
	...
	/// <summary>
	/// Özellike birleşik kelimelerin Snake Case formatında dönüşümü sağlanır.
	/// </summary>
	/// <param name="value"></param>
	/// <returns></returns>
	/// <example>
	/// var name = "MyNameIsMurat";
	/// name.ToSnakeCase(); // => "my_name_is_murat"
	/// </example>
	...
	public static string GetMatchedFirstValue(this string value, params (string Pattern, Func<string, string> Func)[] patterns)
	{
